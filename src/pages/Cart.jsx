      ...
      {cart.cartItems.length > 0 ? (
        <>
            {cart.cartItems.map((product) => (
              ...
              <div key={product.id} className="py-4 container   sm:mx-4   border-t border-b text-gray-700  items-center grid  grid-cols-[2fr_0.5fr_0.5fr] sm:grid-cols-[2fr_2fr_0.5fr]  gap-4">
                <div className="flex items-start  sm:gap-6">
                  <img className="w-16 sm:w-20 mx-4 " src={product.image[0]} alt="" />
                  <div>
                ...
                <div className="flex items-center justify-center sm:mt-0  mt-5 ">
                         ...
                         <p className="sm:text-xl  text-sm sm:px-2  px-1 ">{product.quantity}</p>
                         <button
            ...
            <div className=" w-full sm:w-[450px]  p-6  rounded-lg shadow-md border  ">
               ...
               <button
                 className="w-full bg-red-600 mb-2 text-white py-2 hover:bg-red-800"
                 onClick={() => navigate("/checkout")}
               >
                 Checkout
               </button>
               <button
                 className="w-full bg-white text-black py-2 hover:text-white hover:bg-red-800  border border-black"
                 onClick={() => navigate("/")}
               >
                 CONTINUE SHOPPING
               </button>  
